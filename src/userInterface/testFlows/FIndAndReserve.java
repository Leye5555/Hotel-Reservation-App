package userInterface.testFlows;
                    ...
                    if (room == null) {
                        ...
                        try {
                            if (email == null) {
                                ...
                                existingUser2 = hotelResource.getCustomer(email);
                                if (existingUser2 != null) {
                                    firstName = existingUser2.getFirstName();
                                    lastName = existingUser2.getLastName();
                            ...
                            if (existingUser2 == null) { // prevent recreating the same customer twice
